...
export const REPORT_AUDITS: ReportAudit[] = [
  ...
  { id: 'a1',  templateId: 'tpl-1', name: 'Fire Safety Standard', date: '2024-03-31', status: 'done' },
  { id: 'a2',  templateId: 'tpl-1', name: 'Fire Safety Standard', date: '2024-06-30', status: 'done' },
  { id: 'a3',  templateId: 'tpl-1', name: 'Fire Safety Standard', date: '2024-09-30', status: 'done' },
  { id: 'a4',  templateId: 'tpl-1', name: 'Fire Safety Standard', date: '2024-12-31', status: 'done' },
  { id: 'a5',  templateId: 'tpl-1', name: 'Fire Safety Standard', date: '2025-03-31', status: 'in-progress' },
  { id: 'a19', templateId: 'tpl-1', name: 'Fire Safety Standard', date: '2026-06-30', status: 'in-progress' },
  // Monthly Operations Review — Q1 2024 through Feb 2025
  { id: 'a6',  templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2024-03-31', status: 'done' },
  { id: 'a7',  templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2024-06-30', status: 'done' },
  { id: 'a8',  templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2024-09-30', status: 'done' },
  { id: 'a9',  templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2024-12-31', status: 'done' },
  { id: 'a10', templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2025-01-31', status: 'done' },
  { id: 'a11', templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2025-02-28', status: 'done' },
  { id: 'a12', templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2025-03-31', status: 'in-progress' },
  { id: 'a20', templateId: 'tpl-2', name: 'Monthly Operations Review', date: '2026-05-31', status: 'not-started' as AuditStatus },
  // Visual Merchandising Audit — Q1 2024 through Feb 2025
  { id: 'a13', templateId: 'tpl-3', name: 'Visual Merchandising Audit', date: '2024-03-31', status: 'done' },
  { id: 'a14', templateId: 'tpl-3', name: 'Visual Merchandising Audit', date: '2024-06-30', status: 'done' },
  { id: 'a15', templateId: 'tpl-3', name: 'Visual Merchandising Audit', date: '2024-09-30', status: 'done' },
  { id: 'a16', templateId: 'tpl-3', name: 'Visual Merchandising Audit', date: '2024-12-31', status: 'done' },
  { id: 'a17', templateId: 'tpl-3', name: 'Visual Merchandising Audit', date: '2025-01-31', status: 'done' },
  { id: 'a18', templateId: 'tpl-3', name: 'Visual Merchandising Audit', date: '2025-02-28', status: 'done' },
];
...
const SCORES_TPL1: Record<string, Record<string, number[]>> = {
  ...
  // West Coast
  sf:  { a1: [49,53,51], a2: [59,63,61], a3: [67,71,69], a4: [74,78,76], a5: [76,80,78], a19: [78,82,80] },
  la:  { a1: [43,47,45], a2: [53,57,55], a3: [61,65,63], a4: [68,72,70], a5: [70,74,72], a19: [72,76,74] },
  sea: { a1: [41,45,43], a2: [51,55,53], a3: [59,63,61], a4: [66,70,68], a5: [68,72,70], a19: [70,74,72] },
  por: { a1: [45,49,47], a2: [55,59,57], a3: [63,67,65], a4: [70,74,72], a5: [72,76,74], a19: [74,78,76] },
  // East Coast
  ny:  { a1: [58,62,60], a2: [68,72,70], a3: [77,81,79], a4: [81,84,82], a5: [82,84,83], a19: [84,86,85] },
  bos: { a1: [48,52,50], a2: [58,62,60], a3: [67,71,69], a4: [74,78,76], a5: [76,80,78], a19: [78,82,80] },
  dc:  { a1: [44,48,46], a2: [54,58,56], a3: [63,67,65], a4: [70,74,72], a5: [72,76,74], a19: [74,78,76] },
  // Midwest
  chi: { a1: [39,43,41], a2: [49,53,51], a3: [57,61,59], a4: [64,68,66], a5: [66,70,68], a19: [68,72,70] },
  den: { a1: [31,35,33], a2: [41,45,43], a3: [49,53,51], a4: [56,60,58], a5: [58,62,60], a19: [60,64,62] },
  min: { a1: [37,41,39], a2: [47,51,49], a3: [55,59,57], a4: [62,66,64], a5: [64,68,66], a19: [66,70,68] },
  // Southeast
  atl: { a1: [46,50,48], a2: [56,60,58], a3: [65,69,67], a4: [72,76,74], a5: [74,78,76], a19: [76,80,78] },
  mia: { a1: [43,47,45], a2: [53,57,55], a3: [61,65,63], a4: [68,72,70], a5: [70,74,72], a19: [72,76,74] },
  cha: { a1: [56,60,58], a2: [66,70,68], a3: [75,79,77], a4: [80,83,81], a5: [81,84,82], a19: [83,86,84] },
  // Texas
  dal: { a1: [57,61,59], a2: [67,71,69], a3: [76,80,78], a4: [81,84,82], a5: [82,84,83], a19: [84,86,85] },
  hou: { a1: [54,58,56], a2: [64,68,66], a3: [73,77,75], a4: [79,82,80], a5: [80,83,81], a19: [82,85,83] },
  aus: { a1: [44,48,46], a2: [54,58,56], a3: [63,67,65], a4: [70,74,72], a5: [72,76,74], a19: [74,78,76] },
  // Southwest — lower baseline throughout
  phx: { a1: [32,36,34], a2: [42,46,44], a3: [50,54,52], a4: [57,61,59], a5: [59,63,61], a19: [61,65,63] },
  lv:  { a1: [29,33,31], a2: [39,43,41], a3: [47,51,49], a4: [54,58,56], a5: [56,60,58], a19: [58,62,60] },
  sd:  { a1: [47,51,49], a2: [57,61,59], a3: [66,70,68], a4: [73,77,75], a5: [75,79,77], a19: [77,81,79] },
};
...
const SCORES_TPL2: Record<string, Record<string, number[]>> = {
  ...
  sf:  { a6: [90,86,92], a7: [89,85,91], a8: [88,84,90], a9: [89,85,91], a10: [87,83,89], a11: [70,66,72], a12: [90,86,92], a20: [88,84,90] },
  la:  { a6: [85,83,87], a7: [84,82,86], a8: [83,81,85], a9: [84,82,86], a10: [82,80,84], a11: [64,62,66], a12: [80,82,78], a20: [82,80,84] },
  sea: { a6: [88,85,90], a7: [87,84,89], a8: [86,83,88], a9: [87,84,89], a10: [85,82,87], a11: [67,64,69], a12: [84,81,86], a20: [86,83,88] },
  por: { a6: [82,80,84], a7: [81,79,83], a8: [80,78,82], a9: [81,79,83], a10: [79,77,81], a11: [61,59,63], a12: [72,74,70], a20: [80,78,82] },
  ny:  { a6: [97,95,99], a7: [96,94,98], a8: [95,93,97], a9: [96,94,98], a10: [94,92,96], a11: [77,75,79], a12: [93,91,95], a20: [95,93,97] },
  bos: { a6: [90,88,92], a7: [89,87,91], a8: [88,86,90], a9: [89,87,91], a10: [87,85,89], a11: [70,68,72], a12: [85,87,83], a20: [88,86,90] },
  dc:  { a6: [86,84,88], a7: [85,83,87], a8: [84,82,86], a9: [85,83,87], a10: [83,81,85], a11: [65,63,67], a12: [81,79,83], a20: [84,82,86] },
  chi: { a6: [82,80,84], a7: [81,79,83], a8: [80,78,82], a9: [81,79,83], a10: [79,77,81], a11: [61,59,63], a12: [77,75,79], a20: [80,78,82] },
  den: { a6: [75,73,77], a7: [74,72,76], a8: [73,71,75], a9: [74,72,76], a10: [72,70,74], a11: [54,52,56], a12: [70,72,68], a20: [73,71,75] },
  min: { a6: [79,77,81], a7: [78,76,80], a8: [77,75,79], a9: [78,76,80], a10: [76,74,78], a11: [58,56,60], a12: [74,76,72], a20: [77,75,79] },
  atl: { a6: [87,85,89], a7: [86,84,88], a8: [85,83,87], a9: [86,84,88], a10: [84,82,86], a11: [66,64,68], a12: [82,80,84], a20: [85,83,87] },
  mia: { a6: [83,81,85], a7: [82,80,84], a8: [81,79,83], a9: [82,80,84], a10: [80,78,82], a11: [62,60,64], a12: [78,76,80], a20: [81,79,83] },
  cha: { a6: [92,90,94], a7: [91,89,93], a8: [90,88,92], a9: [91,89,93], a10: [89,87,91], a11: [72,70,74], a12: [86,84,88], a20: [90,88,92] },
  dal: { a6: [96,94,98], a7: [95,93,97], a8: [94,92,96], a9: [95,93,97], a10: [93,91,95], a11: [76,74,78], a12: [90,88,92], a20: [94,92,96] },
  hou: { a6: [93,91,95], a7: [92,90,94], a8: [91,89,93], a9: [92,90,94], a10: [90,88,92], a11: [73,71,75], a12: [87,85,89], a20: [91,89,93] },
  aus: { a6: [86,84,88], a7: [85,83,87], a8: [84,82,86], a9: [85,83,87], a10: [83,81,85], a11: [65,63,67], a12: [81,79,83], a20: [84,82,86] },
  phx: { a6: [75,73,77], a7: [74,72,76], a8: [73,71,75], a9: [74,72,76], a10: [72,70,74], a11: [54,52,56], a12: [72,74,70], a20: [73,71,75] },
  lv:  { a6: [72,70,74], a7: [71,69,73], a8: [70,68,72], a9: [71,69,73], a10: [69,67,71], a11: [51,49,53], a12: [69,71,67], a20: [70,68,72] },
  sd:  { a6: [89,87,91], a7: [88,86,90], a8: [87,85,89], a9: [88,86,90], a10: [86,84,88], a11: [69,67,71], a12: [83,81,85], a20: [87,85,89] },
};
...
function completionDate(storeId: string, auditId: string): string {
  ...
  if (auditId === 'a12' || auditId === 'a19' || auditId === 'a20') return ''; // in-progress or not-started
